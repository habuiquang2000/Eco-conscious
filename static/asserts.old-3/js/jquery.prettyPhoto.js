!function(e) {
    ...
    e.fn.prettyPhoto = function(a) {
        ...
        a = jQuery.extend({
            ...
            custom_markup: "",
            social_tools: 
            '<div class="twitter"><a href="#" class="twitter-share-button" data-count="none"></a><script type="text/javascript" src="/widgets.js"></script></div><div class="facebook"><iframe src="" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:500px; height:23px;" allowTransparency="true"></iframe></div>'
        }, a);
